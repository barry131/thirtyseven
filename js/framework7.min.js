    ...
    window.Framework7 = function(a) {
        ...
        var d = function(e, a) {
            ...
            for (var d = [{
                ...
                for (var m = d[u].letters, f = 0; f < m.length; f++) c[m[f]] = d[u].base;
        ...
        i.triggerPageCallbacks = function(e, a, t) {
            ...
            else o(i.router.temporaryDom).append(h); if (m = a.reload && (a.reloadPrevious ? "left" : "center"), n = b ? C.find('.page[data-page="' + b + '"]') : i.router.findElement(".page", i.router.temporaryDom, e), !n || 0 === n.length || b && e.activePage && e.activePage.name === b) return void(e.allowPageChange = !0);
            ...
            if (e.params.uniqueHistory) {
                ...
                if (e.params.uniqueHistoryIgnoreGetParameters)
                    for (E = [], L = f.split("?")[0], l = 0; l < e.history.length; l++) E.push(e.history[l].split("?")[0]);
                ...
                if (0 !== r.length) {
                    ...
                    if (!(w.disabled || e.hasClass("disabled") || C.hasClass("disabled"))) {
                        ...
                        var V = i._compiledTemplates.smartSelectItem,
                            q = "";
                        if (!g)
                            for (var F = 0; F < B.length; F++) q += V(B[F]);
        ...
        var g = function(e, a) {
            ...
            return r.setListSize = function() {
                ...
                if ("undefined" != typeof a && (t = a), null === r.lastRepaintY || Math.abs(t - r.lastRepaintY) > h || !s && r.pageContent[0].scrollTop + p >= r.pageContent[0].scrollHeight) {
                    ...
                    for (var w = n; i > w; w++) {
                        var C, y;
                        y = r.items.indexOf(o[w]), w === n && (r.currentFromIndex = y), w === i - 1 && (r.currentToIndex = y), y === r.items.length - 1 && (r.reachEnd = !0), r.domCache[y] ? C = r.domCache[y] : (r.tempDomElement.innerHTML = r.template ? r.template(o[w], {
                            index: y
                        }) : r.params.renderItem ? r.params.renderItem(y, o[w]) : o[w], C = r.tempDomElement.childNodes[0], r.params.cache && (r.domCache[y] = C)), C.f7VirtualListIndex = y, w === n && (b = g ? l : w * r.params.height / r.params.cols), C.style.top = b + "px", r.params.onItemBeforeInsert && r.params.onItemBeforeInsert(r, C), r.fragment.appendChild(C)
                    }
                ...
                for (c = 0; c < l.length; c++) {
                    ...
                    if ("plain" !== u.type) {
                        ...
                        if ("variable" === u.type && (m = r(u.contextName, p), d += "r += c(" + m + ", " + p + ");"), "helper" === u.type)
                            if (u.helperName in o.helpers) f = i(u.contextName, p), d += "r += (Template7.helpers." + u.helperName + ").call(" + p + ", " + (f && f + ", ") + "{hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, s + 1) + ", inverse: " + t(u, s + 1) + ", root: ctx_1});";
                            else {
        ...
        if (h.version = "3.1.0", h.params = n, h.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e)) && (h.$ = a, h.container = a(t), 0 !== h.container.length)) {
            ...
            window.navigator.pointerEnabled ? g = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (g = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), h.touchEvents = {
                ...
                if (h.clickedSlide = t, h.clickedIndex = a(t).index(), h.params.slideToClickedSlide && void 0 !== h.clickedIndex && h.clickedIndex !== h.activeIndex) {
                    ...
                    if (h.params.loop)
                        if (i = a(h.clickedSlide).attr("data-swiper-slide-index"), s > h.slides.length - h.params.slidesPerView) h.fixLoop(), s = h.wrapper.children("." + h.params.slideClass + '[data-swiper-slide-index="' + i + '"]').eq(0).index(), setTimeout(function() {
                            h.slideTo(s)
                        }, 0);
